<?php
	...
	//echo $data."</br>".$desc."</br>".$price."</br>".$img."</br>";
?>
...
.page-end{
	...
	<body>
		...
		<div id="showcase1">
			<img id="product-image" src="<?php echo $img ?>" width="300px" height="300px"/>
			<?php echo "<h2 id='product-name'>".$data."</h2>";?>
